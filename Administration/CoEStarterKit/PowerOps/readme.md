...
1. Go to **Azure Active Directory** > **App registrations**.
   ...
   ![Azure AD app registration](PowerOps/media/coe33.PNG "Azure AD app registration")
...
1. Select **PowerApps Runtime Service**, and configure permissions as follows:
   ...
   ![API Permissions - Add a permission](PowerOps/media/git-1.png "Add a permission")

   1. Select **Delegated permissions**, and then select **user_impersonation**.

      ![Delegated permissions](PowerOps/media/git-2.png "Delegated permissions")
...
1. Go to your Development environment. In the example in the following image, we're importing to the environment named **Contoso CoE**.
     ...
     ![Power Apps maker portal environment selection](PowerOps/media/coe6.PNG "Power Apps maker portal environment selection")

1. Create connections to all connectors used as part of the solution.
    1. Go to **Data** > **Connections**.
    1. Select **+ New Connection**.
    1. Search for and select **Common Data Service**.
     ![Select the Datavsere connector](PowerOps/media/msi-connection.png "Select the Dataverse connector")
...
1. Establish connections to activate your solution. If you create a new connection, you must select **Refresh**. You won't lose your import progress.
     ...
     ![Establish connections to activate your solution](PowerOps/media/git-4.png "Establish connections to activate your solution.")
...
1. Select **FieldSecurityForPassword** from the solution.
    ...
    ![Select FieldSecurityForPassword from the solution](PowerOps/media/git-6.png "Select FieldSecurityForPassword from the solution")
1. Select **Users**.

     ![Select Users from Field Security Profile](PowerOps/media/git-7.png "Select Users from Field Security Profile")
1. Select **Add**.
1. Search for Users.

    ![Search for Users for the Field Security Profile](PowerOps/media/git-8.png "Search for Users for the Field Security Profile")
1. **Select** to add them to the security profile.

    ![Select Users to add them to a Field Security Profile](PowerOps/media/git-9.png "Select Users to add them to a Field Security Profile")
1. Repeat this step for all users that will use PowerOps.
1. Select **Save and Close**.

    ![Save the Field Security Profile](PowerOps/media/git-10.png "Save the Field Security Profile")
...
1. Select **Settings** > **Secret** > **New organization secret**
    ![Select Secrets from your GitHub Org Settings](PowerOps/media/git-20.png "Select Secrets from your GitHub Org Settings")
...
1. Select **Private Repositories** from the Repository access dropdown.
         ![Select Private Repositories for your Secret](PowerOps/media/git-21.png "Select Private Repositories for your Secret")
1. Select **Add Secret**.
...
1. Select **Settings** > **Secret** > **New organization secret**
1. Enter **DEV_ENVIRONMENT_SECRET** as a secret name for your Dev deployment stage, and enter the value for your secret.
    ![Select Private Repositories for your Secret](PowerOps/media/git-22.png "Select Private Repositories for your Secret")
1. Select **Add Secret**.
1. Complete the above steps to add a **TEST_ENVIRONMENT_SECRET** and **PROD_ENVIRONMENT_SECRET**.
...
![PowerOps app](PowerOps/media/git-23.png "PowerOps app")
...
![Request approval for a new project](PowerOps/media/git-26.png "Request approval for a new project")
...
![Admins can approve or reject new project requests](PowerOps/media/git-27.png "Admins can approve or reject new project requests")
...
![When an administrator approves a project, a new environment with a Microsoft Dataverse database is created. ](PowerOps/media/git-28.png "When an administrator approves a project, a new environment with a Microsoft Dataverse database is created. ")
...
![When a project is approved, the **Deploy** button is activated](PowerOps/media/git-30.png "When a project is approved, the **Deploy** button is activated")
...
![Deploy your project to test](PowerOps/media/git-31.png "Deploy your project to test")
...
![View deployment status in PowerOps app](PowerOps/media/git-32.png "View deployment status in PowerOps app")
...
![View build details in Github](PowerOps/media/git-33.png "View build details in Github")
...
![Deploy your project to production](PowerOps/media/git-34.png "Deploy your project to production")
...
![View deployment history](PowerOps/media/git-34.png "View deployment history")
